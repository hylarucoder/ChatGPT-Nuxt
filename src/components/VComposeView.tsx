    ...
    return () => (
      <div class="relative flex-col rounded-md border-t p-3 dark:border-gray-600">
        <div class="flex flex-wrap">
          <div class="mb-3 mr-1 flex cursor-pointer items-center rounded-md border px-3 py-1 text-[0.75rem] hover:bg-gray-200 dark:border-gray-600">
        ...
        <div class="flex flex-grow">
          ...
          <div class="absolute bottom-3 right-0 flex h-10 cursor-pointer items-center justify-center truncate rounded-md px-4 py-4 text-center text-white">
            <UButton
              loading={doMessaging.value}
              icon="i-lucide-send"
